...
public class RadarFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ImageButton btnUsr = (ImageButton)view.findViewById(R.id.userEditBttn);
        ...
        Spinner sItems = (Spinner) view.findViewById(R.id.radarSpinner);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.userEditBttn){
            Navigation.findNavController(v).navigate(R.id.action_radarFragment_to_editUserFragment);
        }
